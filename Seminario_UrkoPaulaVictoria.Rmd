...
En este código, ccombinamos con un *left_join( )* las tablas de "tablaEsperanzaDeVidaFinal" y "tablaCalidadDeAguaFinal" mediante su clave común la columna "ComunidadAutonoma", ordenado en función de la Comunidad Autónoma . De esta tabla, consideraremos las culumnas "Aguas2", "Aguas1", "Aguas0",\
"AguasSCF", las cuales son relevantes en nuestro estudio. Gracias a un *pivot_longer( ),* podemos crear una nueva columna "CalidadAgua", agrupando las tres últimas columnas en distintas filas, y otra columna "ValoresCalidadAgua" con los valores correspondientes a esas variables, haciendo más fácil su posterior estudio en la gráfica.
...
En función del gráfico resultante, es necesario saber que en (referenciar pdf) nos aclara que el valor "Aguas 0" se refeiere a aguas no aptas para el baño, "Aguas 1" agas aptas para el baño de buena calidad, "Aguas 2" aguas aptas para el baño de muy buena calidad y "Aguas SFC" se asignan a los puntos del muestreo en los cuales se cumple que al menos un 90% del agua no sobrepasan los valores de Estrptococos Fecales, Transparencia, Oxígeno disuelto y Materias Flotantes*,* y por otro lado no debe cumplirse que el muestreo sea quincenal más un muestreo previo al comienzo de la temporada. Ya aclarado cada valor, podemos apreciar cómo Castilla-La Mancha (27.5)tiene los vlores más bajos en el muestro de sus aguas a diferencia de Galicia (+29) y Extremadura (29) que es el que más alto los tiene. El resto de Comunidades Autónomas, oscilan entre los valores 28.0-28.5, lo que nos indica que (...)
