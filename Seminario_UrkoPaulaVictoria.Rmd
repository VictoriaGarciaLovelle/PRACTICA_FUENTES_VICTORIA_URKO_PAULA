...
Este código extrae y procesa información relevante sobre la calidad del agua de un informe en PDF. Primero, convierte el contenido del PDF a texto y luego selecciona un rango específico de líneas en una página particular del documento, con el objetivo de obtener datos clave relacionados con la calidad del agua.
...
Se dividen los datos en colummnas y se eliminan las primeras 3 dimensiones y la última ya que no son de interés.
Después, se agregan nuevos elementos y se renombran las comunidades autónomas ya que salen descuadradas.
...
Se renombran y se cambia a tipo numérico a aquellas columnas que sea necesario.
``` {r calidad}
