...
En el fragmento de código anterior, unimos mediante un *left_join( )* las tablas de "tablaCantidadDeAguaFinal" y "tablaPresupuestosFinal" mediante la columna "Anio" y "ComunidadAutonoma" ordenado en función de las del presupuesto de manera descendente.
...
Aqui creamos la gráfica de la nueva tabla "grafCantidadPresupuesto" creada a partir del *left_join( )* anterior. En el eje de las ordenadas encontramos la cantidad de agua consumida y en el eje de las abscisas encontramos los presupuestos. Como podemos comprobar en la leyenda, gracias a la función *(...)fill=ComunidadAutonoma))+ geom_bar(stat= "identity")* cada comunidad será representada en la gráfica por un color perteneciente al gradiente y en forma de barra.

De esta tala y gráfico, es notorio como en este caso, si podemos notar una cierta correlación entre el prespuesto invertido en agua y el consumo de esta. Lugares como la Comunidad de Madrid, Andalucía o la Comunidad Valenciana, encabezan con los presupuestos más altos y el conusmo de agua mayor (puede comprobarese en el Anexo I \ref{anexo}). Por otro lado, La Rioja , Cantabria, Extremadura y Aragón, rondanlos últimos puestos tanto en presupuesto como en cantidad. Podelmos destacar Castilla y la Mancha que con un gasto relativamente bajo en agua, tienen un consumo considerable, juto lo contrario de la Comunidad Foral de Navarra. Aun teniendo en cuerta las pocas comunidades que no se rigen por la normalidad de este gráfico, podemos afirmar que una mayor inversión por parte de las Comunidades Autónomas, fomentan un mayor consumo de agua en sus habitantes.
