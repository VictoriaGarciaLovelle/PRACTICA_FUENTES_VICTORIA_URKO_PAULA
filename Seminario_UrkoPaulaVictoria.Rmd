...
```{r CargaLibrerías, eval = TRUE,warning=FALSE}
library(pdftools)
library(tidyverse)
library(tidyjson)
library(tidyr)
...
Para poder obtener la tabla final de la cantidad de agua consumida en cada comunidad autónoma, se ha accedido al atributo de tipo array que contiene la información de interés.
```{r tablaCantidadAgua}
