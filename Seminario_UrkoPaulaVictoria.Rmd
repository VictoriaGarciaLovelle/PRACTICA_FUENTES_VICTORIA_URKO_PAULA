...
![](images/EsperanzadeVidaJson.png){width=900px}
Este es una porcion de todo el archivo JSON, de los cuales se tienen que seleccionar los datos deseados.
...
El PDF tiene 217 páginas de las cuales la página deseada es la 17 que contiene la tabla que queremos obtener.
La tabla en el PDF se muestra asi:

![](images/imagenPDFTabla.png){width=500px}
...
```
En esta tabla final se pueden observar unas columnas llamas Aguas1, Aguas2, Aguas0... Vamos a ver a qué se refieren:
