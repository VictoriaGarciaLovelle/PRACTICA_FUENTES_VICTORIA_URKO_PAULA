...
![](images/imagenPDFTabla){width=250px}

Para poder obtener esta tabla y poder utilizarla para le estudio, primero se convierte el contenido del PDF a texto y luego selecciona un rango específico de líneas en una página particular del documento (página 17), con el objetivo de obtener datos clave relacionados con la calidad del agua.
