...
Para obtener la tabla de la calidad del agua hay que cargar los datos de un archivo pdf.

Para que nos fuese mas fácil hemos obtenido de todo el pdf la página que contenía los datos deseados. De esa página se han obtenido las líneas de interés.
