...
Como coclusión final, podemos ver que la relación entre presupuesto y la cantidad de agua consumida.No obstante si que es notoria pero como vemos la esperanza de vida no se ve afectada por el presupuesto. Podemos comprobar que los extremos en la variable de la cantidad de agua si que perjudican a la esperanza de vida, ya que los que consumen mucha agua o muy poca tienen una esperanza de vida relativament peor a los que consumen una cantidad intermedia. Por otro lado, al superponerse los puntos de calidad de agua, vemos que realmente no es una variable que afecte directamente a nuestro estudio. Es por todo lo anterior, que la esperanza de vida va a ser mayor si nuestra consumo de agua no excede ningun limite, lo que ademas permite que aquellas comunidades autonomas que iniverten mucho capital en el consumo de agua, puedan reducirlo.
