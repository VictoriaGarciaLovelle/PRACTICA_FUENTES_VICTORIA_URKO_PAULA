...
Se crea la importación de los datos Json, después se encuadra el archivo y se accede a todos los tipos almacenados en la variable EsperanzaVida.
...
Al ser una cadena de caracteres, únicamente nos interesa la comunidad autónoma.ñ
