...
En el fragmento de codigo anterior, unimos mediante un *left_join* las tablas de "tablaEsperanzaDeVidaFinal" y "tablaCantidadDeAguaFinal" mediante la columna "Anio" y "ComunidadAutonoma" ordenado en funcion de las Comunidades Autónomas.
